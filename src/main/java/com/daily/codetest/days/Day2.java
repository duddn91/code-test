...
public class Day2 {
	...
	public static int solution(String name) {
		...
		// TODO: 해당 부분은 현실적인 고민이 필요하다. 실제 이름이 들어온다고 가정했을 경우 A가 연속적으로 쓰여지는 영어 이름은 없으나 단순히 알파벳 문자가 나열되어 들어오는 것이라면 좌우 이동에 있어 새로운 알고리즘이 필요하다. 따라서 단순 알파벳 나열일 경우에 대응하는 알고리즘도 만들어보자
